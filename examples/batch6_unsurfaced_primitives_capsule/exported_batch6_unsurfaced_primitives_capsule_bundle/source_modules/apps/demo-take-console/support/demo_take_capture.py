...
Matched private ref: apps/demo-take-console/support/demo_take_capture.py
Boundary class: private_body_exact_match
"""

PUBLIC_MICROCOSM_STUB = True
WITHHELD_PRIVATE_SOURCE_REF = 'apps/demo-take-console/support/demo_take_capture.py'
