...
Matched private ref: tools/meta/factory/run_prover_external_formal_benchmark_smoke.py
Boundary class: private_body_exact_match
"""

PUBLIC_MICROCOSM_STUB = True
WITHHELD_PRIVATE_SOURCE_REF = 'tools/meta/factory/run_prover_external_formal_benchmark_smoke.py'
