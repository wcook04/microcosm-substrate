...
Matched private ref: tools/meta/factory/run_prover_proof_state_search_curriculum.py
Boundary class: private_body_exact_match
"""

PUBLIC_MICROCOSM_STUB = True
WITHHELD_PRIVATE_SOURCE_REF = 'tools/meta/factory/run_prover_proof_state_search_curriculum.py'
