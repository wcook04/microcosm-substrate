...
Matched private ref: tools/meta/factory/validate_reasoning_execution_receipt.py
Boundary class: private_body_exact_match
"""

PUBLIC_MICROCOSM_STUB = True
WITHHELD_PRIVATE_SOURCE_REF = 'tools/meta/factory/validate_reasoning_execution_receipt.py'
