...
Matched private ref: system/lib/compliance/compliance_coverage_adapter.py
Boundary class: private_body_exact_match
"""

PUBLIC_MICROCOSM_STUB = True
WITHHELD_PRIVATE_SOURCE_REF = 'system/lib/compliance/compliance_coverage_adapter.py'
