...
Matched private ref: tools/meta/factory/run_lean_full_fidelity_packet_replay.py
Boundary class: private_body_exact_match
"""

PUBLIC_MICROCOSM_STUB = True
WITHHELD_PRIVATE_SOURCE_REF = 'tools/meta/factory/run_lean_full_fidelity_packet_replay.py'
