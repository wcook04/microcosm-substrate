...
Matched private ref: tools/meta/factory/run_verisoftbench_micro10_harness_differential.py
Boundary class: private_body_exact_match
"""

PUBLIC_MICROCOSM_STUB = True
WITHHELD_PRIVATE_SOURCE_REF = 'tools/meta/factory/run_verisoftbench_micro10_harness_differential.py'
