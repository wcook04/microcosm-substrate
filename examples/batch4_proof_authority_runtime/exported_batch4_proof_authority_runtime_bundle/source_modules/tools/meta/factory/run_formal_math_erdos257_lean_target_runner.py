...
Matched private ref: tools/meta/factory/run_formal_math_erdos257_lean_target_runner.py
Boundary class: private_body_exact_match
"""

PUBLIC_MICROCOSM_STUB = True
WITHHELD_PRIVATE_SOURCE_REF = 'tools/meta/factory/run_formal_math_erdos257_lean_target_runner.py'
