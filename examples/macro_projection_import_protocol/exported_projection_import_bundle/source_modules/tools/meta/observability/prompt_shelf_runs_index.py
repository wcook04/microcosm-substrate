...
Matched private ref: tools/meta/observability/prompt_shelf_runs_index.py
Boundary class: private_body_exact_match
"""

PUBLIC_MICROCOSM_STUB = True
WITHHELD_PRIVATE_SOURCE_REF = 'tools/meta/observability/prompt_shelf_runs_index.py'
