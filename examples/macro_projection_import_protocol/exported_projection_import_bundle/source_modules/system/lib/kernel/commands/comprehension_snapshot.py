...
Matched private ref: system/lib/kernel/commands/comprehension_snapshot.py
Boundary class: private_body_exact_match
"""

PUBLIC_MICROCOSM_STUB = True
WITHHELD_PRIVATE_SOURCE_REF = 'system/lib/kernel/commands/comprehension_snapshot.py'
